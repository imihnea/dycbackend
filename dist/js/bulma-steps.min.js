...
var defaultOptions = {
        ...
        switch( step_id ) {
          case 0:
            // DO YOUR VALIDATION FOR FIRST STEP (steps_id start at 0)
                ...
                var counter = e.options[e.selectedIndex].value;
              fetch('/dashboard/addresses/altcoins/rate', {
                method: 'POST',
                headers: {
              ...
              .then(function(data) {
                document.getElementById('depositCoin').value = counter;
                document.getElementById('rate').value = data.rate;
                document.getElementById('min').value = data.limitMinDepositCoin;
                document.getElementById('max').value = data.limitMaxDepositCoin;
                document.getElementById('fee').value = data.minerFee;
            ...
            break;
          case 1:
          var deposit = document.getElementById('depositCoin').value;
          var amount = document.getElementById('depositCoinAmount').value;
          var refund = document.getElementById('refundAddress').value;
          var currentUser = document.getElementById('currentUser').value;
          var coin = document.getElementById('depositCoin').value;
              fetch('/dashboard/addresses/altcoins/deposit', {
                method: 'POST',
                headers: {
                  "Content-Type": "application/json",
                  Accept: 'application/json',
              },
              body: JSON.stringify({deposit: deposit, amount: amount, refund: refund, user: currentUser, depositCoin: coin}),
              })
              .then(function(response) {
                if(response.ok) {
                  console.log('Click was recorded');
              ...
              .then(function(data) {
                document.getElementById('depositAddress').value = data.exchangeAddress.address;
                document.getElementById('expectedAmount').value = data.expectedDepositCoinAmount;
                document.getElementById('orderIdHidden').value = data.orderId;
              })
              .catch(function(error) {
                console.log(error);
              });
            break;
          case 2:
            var orderId1 = document.getElementById('orderIdHidden').value;
              fetch('/dashboard/addresses/altcoins/status', {
                method: 'POST',
                headers: {
                  "Content-Type": "application/json",
                  Accept: 'application/json',
              },
              body: JSON.stringify({orderId: orderId1}),
              })
              .then(function(response) {
                if(response.ok) {
                  console.log('Click was recorded');
              ...
              .then(function(data) {
                console.log('last step console log')
                document.getElementById('orderId').value = data.orderId;
                document.getElementById('status').value = data.status;
                document.getElementById('createDate').value = data.createdAt;
                document.getElementById('expirationDate').value = data.validTill;
              })
              .catch(function(error) {
                console.log(error);
              });
    ...
    if(end !== 'end') {
      fetch('/dashboard/addresses/altcoins/poll', {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          Accept: 'application/json',
      ...
      .then(function(data) {
        console.log('On finish console log')
